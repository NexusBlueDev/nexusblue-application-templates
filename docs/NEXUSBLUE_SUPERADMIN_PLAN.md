...
| Seed | Initial PIN set as bcrypt hash in migration 038 seed data — PIN value set in seed script only, never in plan docs or CLAUDE.md |
...
### Database Addition (Migration 038)
...
> **Note:** Migrations 033–037 are all in use on nexusblue-website (033 = another feature, 034 = appvault_consulting, 035, 036, and 037 also confirmed taken 2026-03-01).
> This schema goes in as **038** — confirmed 2026-03-01.

All tables prefixed `dev_` to distinguish from product feature tables.

```sql
-- ============================================================
-- Migration 038: NexusBlue Super-Admin Portal
-- ============================================================
...
1. **Migration 038** — apply `dev_` tables + `dev_portal_config` + RLS + seed data to nexusblue-website Supabase (034 = appvault_consulting, 035, 036, and 037 also confirmed taken 2026-03-01)
...
| `supabase/migrations/038_superadmin_portal.sql` | dev_ tables + dev_portal_config + RLS (034–037 all taken) |
